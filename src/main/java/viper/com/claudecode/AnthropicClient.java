 ...
 * 通过 ANTHROPIC_BASE_URL 可指向任意兼容 Anthropic 协议的网关
 * （例如 DeepSeek 的 https://api.deepseek.com/anthropic）。
 */
public class AnthropicClient {
    ...
    public AnthropicClient() {
        ...
        this.baseUrl = (b == null || b.isBlank())
                ? "https://api.anthropic.com" : trimSlash(b);
